...
namespace UParking.App.Persistencia.Migrations
{
    ...
    [Migration("20210915000641_00_Entidades")]
    partial class _00_Entidades
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UParking.App.Dominio.Parqueadero", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UParking.App.Dominio.Persona", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UParking.App.Dominio.Puesto", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UParking.App.Dominio.Transaccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UParking.App.Dominio.Vehiculo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UParking.App.Dominio.Administrativo", b =>
                {
                    b.HasBaseType("UParking.App.Dominio.Persona");
            ...
            modelBuilder.Entity("UParking.App.Dominio.Estudiante", b =>
                {
                    b.HasBaseType("UParking.App.Dominio.Persona");
            ...
            modelBuilder.Entity("UParking.App.Dominio.Profesor", b =>
                {
                    b.HasBaseType("UParking.App.Dominio.Persona");
            ...
            modelBuilder.Entity("UParking.App.Dominio.Visitante", b =>
                {
                    b.HasBaseType("UParking.App.Dominio.Persona");
            ...
            modelBuilder.Entity("UParking.App.Dominio.Persona", b =>
                {
                    b.HasOne("UParking.App.Dominio.Parqueadero", null)
                        .WithMany("personasAutorizadas")
                        .HasForeignKey("Parqueaderoid");

                    b.HasOne("UParking.App.Dominio.Vehiculo", "vehiculo_1")
                        .WithMany()
                        .HasForeignKey("vehiculo_1id");

                    b.HasOne("UParking.App.Dominio.Vehiculo", "vehiculo_2")
                        .WithMany()
            ...
            modelBuilder.Entity("UParking.App.Dominio.Puesto", b =>
                {
                    ...
                    b.HasOne("UParking.App.Dominio.Vehiculo", "vehiculo")
                        .WithMany()
            ...
            modelBuilder.Entity("UParking.App.Dominio.Visitante", b =>
                {
                    b.HasOne("UParking.App.Dominio.Persona", "autoriza")
                        .WithMany()
